...
import ru.morozov.graduation.util.UserUtil;
...
import static ru.morozov.graduation.web.user.ProfileController.REST_URL;
import static ru.morozov.graduation.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
...
class ProfileControllerTest extends AbstractControllerTest {
    ...
    void delete() throws Exception {
        ...
        USER_MATCHER.assertMatch(userRepository.findAll(), admin, guest, nextUser);
    }
